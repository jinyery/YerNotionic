      ...
      <div className='container mx-auto flex px-5 py-2 mb-10 md:flex-row flex-col items-center'>
        <div className='flex flex-col md:w-4/5 md:items-start mb-6 md:mb-0 md:text-left'>
          ...
          <h2 className='text-xl pt-8 pb-4 font-light text-gray-500 dark:text-day'>
            {t.HERO.WEEKLY.SUBSCRIPTION_HEAD}
          </h2>
            ...
            {showCopied ? (
              ...
              >
                ...
                <span className='ml-4 flex items-start flex-col leading-none'>
                  ...
                  <span className='font-medium'>{t.HERO.WEEKLY.RSS_BUTTON}</span>
                </span>
              </button>
            )}
          </div>
        </div>
        <div className='w-2/5' style={{ marginBottom: '60px' }}>
